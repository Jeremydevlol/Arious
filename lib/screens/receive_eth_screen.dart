...
class _ReceiveEthScreenState extends State<ReceiveEthScreen> {
  ...
  void _copyAddress() {
    if (_woonklyWalletController.account.value != null) {
      Clipboard.setData(
        ClipboardData(text: _woonklyWalletController.account.value!),
      );
      Get.snackbar(
        'Dirección Copiada',
        'La dirección se ha copiado al portapapeles',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: Obx(() {
          final address = _woonklyWalletController.account.value;
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Por favor conecta tu wallet para recibir Woonkly',
                    style: TextStyle(
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                Text(
                  'Comparte esta dirección para recibir Woonkly',
                  style: TextStyle(
                    color: Colors.white.withOpacity(0.7),
                    fontSize: 16,
                  ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 12),
                      Text(
                        '• Solo envía Woonkly y otros tokens BEP-20 a esta dirección\n'
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 12),
                      Text(
                        '${_woonklyWalletController.woonlyBalance.value.toStringAsFixed(6)} WOOP',
                        style: const TextStyle(
                          color: Colors.white,
                          fontSize: 24,
                          fontWeight: FontWeight.w700,
                      ...
                      const SizedBox(height: 8),
                      Text(
                        'BNB: ${_woonklyWalletController.bnbBalance.value.toStringAsFixed(6)} BNB',
                        style: const TextStyle(
