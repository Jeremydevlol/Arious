...
class _SendEthScreenState extends State<SendEthScreen> {
  ...
  void _updateGasEstimate() async {
    ...
    try {
      ...
      if (amount != null && amount > 0) {
        ...
        final currentBnb = _woonklyWalletController.bnbBalance.value;
  ...
  Future<void> _sendTransaction() async {
    ...
    try {
      ...
      // Validar cantidad
      final amountError = _woonklyWalletController.validateAmount(
      ...
      // Validar gas
      final gasError = await _woonklyWalletController.validateGasRequirement(
        amount,
      );
      if (gasError != null) {
      ...
      // Enviar transacción
      final txHash = await _woonklyWalletController.sendWoonkly(
        to: address,
        amount: amount,
      );
                ...
                Column(
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            ...
                            final maxAmount =
                                _woonklyWalletController.woonlyBalance.value *
                                0.999;
                    ...
                    TextFormField(
                      ...
                      validator: (value) {
                        return _woonklyWalletController.validateAmount(
                          value ?? '',
                        );
                      },
                    ),
