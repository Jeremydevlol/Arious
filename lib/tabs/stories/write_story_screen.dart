...
class _WriteStoryScreenState extends State<WriteStoryScreen>
  ...
  // Paleta de colores predefinidos más atractivos
  final List<Color> colorPalette = [
    const Color(0xFF1A1A2E), // Azul oscuro elegante
    const Color(0xFF16213E), // Azul marino profundo
    const Color(0xFF0F3460), // Azul medianoche
    const Color(0xFF533483), // Púrpura real
    const Color(0xFF7209B7), // Púrpura vibrante
    const Color(0xFFE21D48), // Rojo pasión
    const Color(0xFFFF6B35), // Naranja fuego
    const Color(0xFFFFBE0B), // Amarillo dorado
    const Color(0xFF8AC926), // Verde lima
    const Color(0xFF52B788), // Verde esmeralda
    const Color(0xFF264653), // Verde bosque
    const Color(0xFF2A9D8F), // Turquesa
    const Color(0xFF457B9D), // Azul acero
    const Color(0xFF1D3557), // Azul profundo
    const Color(0xFF6A4C93), // Púrpura místico
    const Color(0xFFB56576), // Rosa polvoso
  ];
